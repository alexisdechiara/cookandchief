        ...
        <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
          ...
          <form class="flex flex-col pt-3 md:pt-8" v-on:submit="register" method="POST">
            ...
            <div class="flex flex-col pt-4">
              ...
              <input type="email" required id="email" placeholder="votre@mail.com" :class="emailError || alreadyExists ? 'border-red-600' : 'border-gray-300'" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-yellow-600 focus:ring-yellow-600 focus:outline-none" />
            ...
            <div class="flex flex-col pt-4">
              ...
              <input type="password" required id="password" placeholder="··········" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 border-gray-300 focus:text-gray-700 focus:bg-white focus:border-yellow-600 focus:ring-yellow-600 focus:outline-none" />
            </div>

            <button type="submit" class="p-2 mt-8 w-full inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-md leading-normal uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-600 active:shadow-lg transition duration-150 ease-in-out"> S'inscrire </button>
          </form>
          <div class="text-center pt-12 pb-12">
            <div>Déjà un compte ? <router-link to="/login" class="underline font-semibold">Se connecter</router-link></div>
          </div>
        </div>
